...
在仓库根目录运行：
    python -B practice/lesson-10/recovery_demo.py
    python -B practice/lesson-10/recovery_demo.py --observed unknown
    python -B practice/lesson-10/recovery_demo.py --observed running
