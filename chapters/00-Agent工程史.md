...
2023 年 3 月，早期 Auto-GPT 第一次向大众展示了“让模型自主连续行动”的原型：它能连续选择搜索、网页摘要和记忆操作，每走一步停下来等人按 `y` 批准。[最早 Prompt](https://github.com/Significant-Gravitas/AutoGPT/commit/b099adcb0830ab00c003749c2ae2cf0f5ec5524a)、[早期循环](https://github.com/Significant-Gravitas/AutoGPT/commit/68640a58640156398aea344da21683a5f7f27487)

当时有开发者给它设定目标“让公司营收最大化”。半小时后，他的信用卡收到了数百美元的 API 账单，而终端里的 Agent 正陷入一种奇妙的狂热：它把自己的全部思考过程写进了一个巨大的本地文本文档，然后一遍遍用 Google 搜索“如何阅读这个文本文档”。

这种啼笑皆非的失控，并不是某一个早产项目的独家笑话，而是整个行业过去几年交出百亿美元学费的缩影：循环失控、上下文爆炸、工具越权、崩溃重试引发连环灾难……Agent 工程从来不是谁提前在图纸上规划出来的，每当 Agent 多获得一种行动能力，系统就会暴露一种全新的灾难；下一层工程体系，往往就是为了填平上一次灾难留下的深坑。
