...
* [第 3 课：Tool Calling Loop——从调用请求到最终回答](chapters/03-工具调用循环.md)
...
* [第 6 课：Agent 存储——JSONL 与 SQLite 的选择](chapters/06-Agent存储.md)
* [第 7 课：Tool Reliability——幂等、Ledger 与故障恢复](chapters/07-工具可靠性.md)
* [第 8 课：Agent Sandbox——审批、权限与执行边界](chapters/08-Agent沙盒.md)
