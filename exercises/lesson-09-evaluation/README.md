...
本课的主线已整理为[第 9 课正文：任务验收与回归门禁](../../chapters/09-Agent评估.md)。如果已经跑过真实任务，直接阅读正文，再执行文末[最小门禁](#第八步-h固定回归题的最小门禁)即可；下面保留实现过程，供需要查代码时阅读。
...
本节到此收口。代码和自检由 AI 补齐，你只需跑一次离线门禁并能解释拒绝原因，不再安排新题型或逐题考试。
